...
let imageUrl = getImageUrl(data.image.url)
</script>

<div class="relative flex h-[59vw] items-end justify-center overflow-hidden bg-gradient-to-br from-blue-500 to-sky-400 lg:hidden lg:h-[50vw]">
        <svg
          id="visual"
          viewBox="0 0 900 600"
          width="100%"
          ...
          version="1.1"
          class="z-20 fill-white dark:fill-zinc-900"
        >
        ...
        <div
  style="left: 30%; top: 80%; transform: translate(-50%, -50%);"
  class="absolute z-10 w-1/3 overflow-hidden"
>
  <img
    src={imageUrl}
    alt={data.image.alt}
    class="z-10 overflow-hidden lg:hidden"
  />
</div>
      </div>
        ...
        <div class="container mx-auto lg:flex lg:max-w-[72rem]">
          <div class="space-y-7  lg:mx-0 lg:w-1/2 lg:space-y-8">
            <div class="space-y-6 lg:space-y-10">
              ...
              <form class="w-full lg:relative" >
                <input
                  name="email" 
                  class="placeholder:text-slate-11 z-20 h-20 w-full rounded-[20px] bg-neutral-100 pl-8 pr-10 text-slate-900 outline-none ring-0 focus:ring-0 focus-visible:outline-none"
                  type="email"
  ...
  <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
    <stop offset="0%" stop-color="#68ddfd" stop-opacity="1" />
    <stop offset="100%" stop-color="#3490dc" stop-opacity="1" />
  </linearGradient>
</defs>
          ...
          <div
  style="left: 70%; top: 80%; transform: translate(-50%, -50%);"
  class="absolute z-10 w-3/12"
>
  <img
    src={imageUrl}
    alt={data.image.alt}
    class="z-10 hidden overflow-hidden lg:block"
  />
</div>
        </div>
      </div>