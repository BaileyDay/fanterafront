			...
			{#each data.members as staff}
				<li>
					<img
						...
						src={getImageUrl(staff.user.profilePicture.url)}
						alt=""
					/>
					<h3 class="mt-6 text-lg font-semibold leading-8 text-gray-900">{staff.user.username}</h3>
					<p class="text-base leading-7 text-sky-500 font-bold">{staff.position}</p>
